...
public class Test_Graduate_Button {
    //This test check the functionality of the Graduate Calendar button transparency when you hover the mouse.
    ...
    public static void main(String[] args) {
        ...
        WebElement link_grdcal = driver.findElement(By.id("fusion-tab-graduatecalendar"));
